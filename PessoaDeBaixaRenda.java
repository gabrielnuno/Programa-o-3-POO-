...
public class PessoaDeBaixaRenda extends Cliente { // Herda os atributos da classe Cliente.

    public PessoaDeBaixaRenda(String identificacao, String nome, int idade) {
