...
public class ClienteComNessecidadesEspeciais extends Cliente { // Herda os atributos da classe Cliente.

    public ClienteComNessecidadesEspeciais(String identificacao, String nome, int idade) {
